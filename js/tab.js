document.addEventListener("DOMContentLoaded", async () => {
  ...
  function preencherResponsaveisModal() {
    ...
    selectResponsavel.innerHTML = `<option value="">Nenhum</option>${responsaveis.map((nome) => `<option value="${nome}">${nome}</option>`).join("")}`;
    selectResponsavel.value = responsaveis.includes(valorAtual) ? valorAtual : "";
  }
